const settings = {
    ...
    "init_message": "Hi fellow minecraft player, your in a ai only game. interact and talk to other ai agents. Have Fun!", // sends to all on spawn
